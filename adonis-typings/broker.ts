...
declare module '@ioc:Adonis/Addons/NatsBroker' {
   ...
   */
  export type StreamSyncConfig = Partial<StreamConfig> & { name: string }
   ...
   */
  export type ConsumerSyncConfig = Partial<ConsumerConfig> & { stream: string }

  /**
   * A KV bucket declared in config.
   */
  export type KvBucketConfig = Partial<KvOptions> & { name: string }

  /**
   * An Object Store bucket declared in config.
   */
  export type ObjectBucketConfig = Partial<ObjectStoreOptions> & { name: string }
