...
class MakeTest extends standalone_1.BaseCommand {
    async run() {
        const stub = (0, path_1.join)(__dirname, '..', 'templates', 'test.txt');
...
MakeTest.commandName = 'make:nats:test';
MakeTest.description = 'Make a new Nats test';
exports.default = MakeTest;
__decorate([
    standalone_1.args.string({ description: 'Name of the nats test' }),
