...
class MakeController extends standalone_1.BaseCommand {
     ...
     */
    async run() {
        const stub = (0, path_1.join)(__dirname, '..', 'templates', 'exception.txt');
...
MakeController.commandName = 'make:nats:exception';
MakeController.description = 'Make a new Nats exception';
exports.default = MakeController;
__decorate([
    standalone_1.args.string({ description: 'Name of the nats exception' }),
