...
class MakeController extends standalone_1.BaseCommand {
     ...
     */
    async run() {
        const stub = (0, path_1.join)(__dirname, '..', 'templates', 'middleware.txt');
        ...
        this.generator
            ...
            .stub(stub)
            .destinationDir('app/Middleware/Nats')
            .useMustache()
...
MakeController.commandName = 'make:nats:middleware';
MakeController.description = 'Make a new Nats middleware';
exports.default = MakeController;
__decorate([
    standalone_1.args.string({ description: 'Name of the nats middleware' }),
